...
cd ./out && tar vcfz jim-linux-amd64.tar.gz README.md jim && cd -
rm ./out/jim

echo "darwin"
env GOOS=darwin;GOARCH=amd64; go build -ldflags="-X 'jim/utils.Version=$1'" -o ./out/jim ./cmd/
cd ./out && tar vcfz jim-darwin-amd64.tar.gz README.md jim && cd -
rm ./out/jim

echo "windows"
env GOOS=windows;GOARCH=amd64; go build -ldflags="-X 'jim/utils.Version=$1'" -o ./out/jim.exe ./cmd/
cd ./out && tar vcfz jim-windows-amd64.tar.gz README.md jim.exe && cd -
rm ./out/jim.exe
